...
const Navbar: FunctionComponent<Props> = ({ title, description, onTitlebarClick, onLeftButtonClick, isUserLoggedIn, isUserPremium, loginRedirectUrl, avatarUrl, className }) => {
  ...
  return (
    <AppBar className={cn(classes.appBar, className)} elevation={0}>
